...
class TestCommands(unittest.TestCase):
    ...
    def test_setconfig_non_auth_list(self):
        self.assertEqual(['file:///var/www/', 'https://futurocoin.org'],
            Commands._setconfig_normalize_value('url_rewrite', "['file:///var/www/','https://futurocoin.org']"))
        self.assertEqual(['file:///var/www/', 'https://futurocoin.org'],
            Commands._setconfig_normalize_value('url_rewrite', '["file:///var/www/","https://futurocoin.org"]'))
    ...
    def test_setconfig_auth(self):
        ...
        self.assertEqual("['file:///var/www/','https://futurocoin.org']",
            Commands._setconfig_normalize_value('rpcpassword', "['file:///var/www/','https://futurocoin.org']"))
