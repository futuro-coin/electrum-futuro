...
class BitcoinAverage(ExchangeBase):
    ...
    def get_rates(self, ccy):
        ...
        return dict([(r.replace("FTO", ""), Decimal(json[r]['last']))
    ...
    def request_history(self, ccy):
        history = self.get_csv('apiv2.bitcoinaverage.com',
                               "/indices/global/history/FTO%s?period=alltime&format=csv" % ccy)
...
class BitcoinVenezuela(ExchangeBase):
    ...
    def get_rates(self, ccy):
        ...
        rates = [(r, json['FTO'][r]) for r in json['FTO']
                 if json['FTO'][r] is not None]  # Giving NULL for LTC
        return dict(rates)
    ...
    def request_history(self, ccy):
        return self.get_json('api.bitcoinvenezuela.com',
                             "/historical/index.php?coin=FTO")[ccy +'_FTO']
...
class Bitmarket(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json = self.get_json('www.bitmarket.pl', '/json/FTOPLN/ticker.json')
...
class FTOParalelo(ExchangeBase):
...
class CoinMarketCap(ExchangeBase):
    def get_rates(self, ccy):
        json = self.get_json('api.coinmarketcap.com', '/v1/ticker/fto/')
        quote_currencies = {}
...
class Yobit(ExchangeBase):
    ...
    def get_rates(self, ccy):
        json_usd = self.get_json('yobit.net', '/api/3/ticker/fto_usd')
        json_btc = self.get_json('yobit.net', '/api/3/ticker/fto_btc')
        return {'USD': Decimal(json_usd['fto_usd']['last']),
				'BTC': Decimal(json_btc['fto_btc']['last'])}
