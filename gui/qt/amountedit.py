...
class AmountEdit(MyLineEdit):
    ...
    def __init__(self, base_unit, is_int = False, parent=None):
        ...
        # This seems sufficient for hundred-FTO amounts with 8 decimals
...
class FTOAmountEdit(AmountEdit):
...
class FeerateEdit(FTOAmountEdit):
    def _base_unit(self):
        return 'sat/byte'

    def get_amount(self):
        sat_per_byte_amount = FTOAmountEdit.get_amount(self)
