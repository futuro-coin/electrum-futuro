...
try:
    ...
    from btchip.btchipException import FTOhipException
    FTOHIP = True
    FTOHIP_DEBUG = is_verbose
except ImportError:
    FTOHIP = False
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in Futurocoin mode")) from e
                raise e
...
class LedgerPlugin(HW_PluginBase):
    ...
    def get_btchip_device(self, device):
        ...
        return HIDDongleHIDAPI(dev, ledger, FTOHIP_DEBUG)
